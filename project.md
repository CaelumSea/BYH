...
## 愿景与目标
把 BYH 做成安静、便携、快捷直达的 Windows 原生效率工具：用户完成选取、识别、翻译、提示词和启动操作时，不需要离开当前上下文。

## 目标用户
重视本地优先、低打扰与视觉品质，希望通过全局快捷键快速处理文字、截图、剪贴板和应用启动的 Windows 用户。

## 硬约束
- Windows 10+，.NET 10、Avalonia 12.1、NativeAOT 发布。
- 后台常驻、全局快捷键、截图和 UI Automation 行为不能因视觉主题而改变。
- 配置与用户主题存放在 `%LOCALAPPDATA%\BYH\`，不得把密钥写入主题包。
- 主题切换必须可恢复；无效或不完整主题自动回退到内置 Ivory Jade。
- 保持轻量，不引入浏览器运行时或 Electron。
...
## 当前焦点需求
REQ-027：设计 BYH 的皮肤自定义与运行时切换系统，在保留 NativeAOT、原生交互和 Ivory Jade 视觉质量的前提下支持内置主题与受约束的用户主题包。

## 任务历史
- [[REQ-026]] 设置页滚动范围与底部内容完整性修复 — done (2026-07-24)
- [[REQ-025]] 设置页截图 UIA 自动化可靠性 — done (2026-07-24)
- [[REQ-024]] 同步主线功能并优化设置界面 v9 — done (2026-07-24)
- [[REQ-023]] 设置页艺术字与宝石背景迁移 v8 — done (2026-07-22)
- [[REQ-022]] 设置页左栏节奏与手机比例 v7 — done (2026-07-22)
- [[REQ-021]] 设置页对称小手机与参考式左栏 v6 — done (2026-07-22)
- [[REQ-020]] 设置页小手机比例与杂志式概念栏 v5 — done (2026-07-22)
- [[REQ-019]] 参考色板亮化与导航均衡 — done (2026-07-22)
- [[REQ-018]] 设置页报纸栏与主题面板 v3 — done (2026-07-22)
- [[REQ-017]] 设置页阴影层次与左栏柔化 v2 — done (2026-07-22)
- [[REQ-016]] 设置页宏观边框结构修正 v1 — done (2026-07-22)
