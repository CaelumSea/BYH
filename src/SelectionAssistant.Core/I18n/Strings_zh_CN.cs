...
internal static partial class Strings_zh_CN
{
    public static Dictionary<string, string> Build() => new(256, StringComparer.Ordinal)
    {
        ...
        ["Settings_PowerMonitor_LhmPath_Hint"] = "选择 LibreHardwareMonitor.exe 的位置。LHM 离线时点「启动 LHM」会以管理员身份打开它（弹出 UAC 确认）。",
        ["Settings_PowerMonitor_StartLhm"] = "启动 LHM",
        ["Settings_PowerMonitor_LhmStarting"] = "正在启动 LHM…请在 UAC 弹窗里点「是」。",
        ["Settings_PowerMonitor_LhmNotFound"] = "尚未设置或找不到 LHM 程序，请先点「浏览」选择。",
