...
internal static partial class Strings_zh_CN
{
    public static Dictionary<string, string> Build() => new(256, StringComparer.Ordinal)
    {
        ...
        ["Settings_TTS_VoiceChinese"] = "中文音色",
        ["Settings_TTS_VoiceEnglish"] = "英文音色",
        ["Settings_TTS_VoiceMixed"] = "混合音色",
        ...
        ["Settings_PowerMonitor_LhmPath"] = "LHM 程序路径",
        ["Settings_PowerMonitor_LhmPath_Hint"] = "留空则自动使用 BYH 目录下 tools\\LibreHardwareMonitor\\ 里的 LHM；也可浏览选择其它位置。LHM 离线时点「启动 LHM」会以管理员身份打开它（弹出 UAC 确认）。",
        ["Settings_PowerMonitor_StartLhm"] = "启动 LHM",
        ["Settings_PowerMonitor_LhmStarting"] = "正在启动 LHM…请在 UAC 弹窗里点「是」。",
        ["Settings_PowerMonitor_LhmNotFound"] = "找不到 LHM 程序（默认 tools\\LibreHardwareMonitor 也没有），请点「浏览」选择。",
