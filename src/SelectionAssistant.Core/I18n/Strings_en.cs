...
internal static partial class Strings_en
{
    public static Dictionary<string, string> Build() => new(256, StringComparer.Ordinal)
    {
        ...
        ["Settings_Provider_ApiKey_Hint"] = "Encrypted with Windows DPAPI. Leave blank to keep the saved key.",
        ...
        ["Settings_Provider_Saved"] = "Provider saved.",
        ["Settings_Provider_SavedKeyFailed"] = "Provider saved, but the API key could not be stored. Enter it again and retry.",
        ["Settings_Show"] = "Show",
        ...
        ["Settings_TTS_VoiceChinese"] = "Chinese voice",
        ["Settings_TTS_VoiceEnglish"] = "English voice",
        ["Settings_TTS_VoiceMixed"] = "Mixed voice",
        ...
        // SettingsWindow — Power Monitoring section
        ["Settings_PowerMonitor_Title"] = "Power Monitoring",
        ["Settings_PowerMonitor_Nav"] = "Power",
        ["Settings_PowerMonitor_Enabled"] = "Poll Libre Hardware Monitor Web Server",
        ["Settings_PowerMonitor_Endpoint"] = "LHM data.json endpoint",
        ["Settings_PowerMonitor_Endpoint_Hint"] = "Install Libre Hardware Monitor, enable its Web Server (Options → Remote), and paste the data.json URL here.",
        ["Settings_PowerMonitor_PollInterval"] = "Poll interval (ms)",
        ["Settings_PowerMonitor_ShowInTray"] = "Show live watts in tray tooltip",
        ["Settings_PowerMonitor_TrackEnergy"] = "Accumulate energy (Wh/kWh)",
        ["Settings_PowerMonitor_AlertEnabled"] = "Alert on temperature threshold",
        ["Settings_PowerMonitor_CpuTemp"] = "CPU alert (°C)",
        ["Settings_PowerMonitor_GpuTemp"] = "GPU alert (°C)",
        ["Settings_PowerMonitor_SsdTemp"] = "SSD alert (°C)",
        ["Settings_PowerMonitor_HistoryRetention"] = "History retention (days)",
        ["Settings_PowerMonitor_Test"] = "Test connection",
        ["Settings_PowerMonitor_AlertTest"] = "Test alert sounds",
        ["Settings_PowerMonitor_ClearHistory"] = "Clear history",
        ["Settings_PowerMonitor_HistorySize"] = "History: {0} samples · {1}",
        ["Settings_PowerMonitor_Saved"] = "Saved.",
        ["Settings_PowerMonitor_Offline"] = "LHM offline",
        ["Settings_PowerMonitor_LhmPath"] = "LHM executable path",
        ["Settings_PowerMonitor_LhmPath_Hint"] = "Leave blank to auto-use the bundled tools\\LibreHardwareMonitor\\ next to BYH.exe, or Browse for another location. When LHM is offline, 'Start LHM' launches it as administrator (UAC prompt).",
        ["Settings_PowerMonitor_StartLhm"] = "Start LHM",
        ["Settings_PowerMonitor_LhmStarting"] = "Starting LHM... confirm the UAC prompt.",
        ["Settings_PowerMonitor_LhmNotFound"] = "LHM executable not found (no bundled tools\\LibreHardwareMonitor either) — pick it via Browse.",
        ["Settings_SavePowerMonitor"] = "Save",
        ["Settings_PageTitle_PowerMonitor"] = "Power / 功耗",
        ["Settings_PageSubtitle_PowerMonitor"] = "Poll Libre Hardware Monitor for live power, temperature, and energy tracking.",
