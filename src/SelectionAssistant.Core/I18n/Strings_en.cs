...
internal static partial class Strings_en
{
    public static Dictionary<string, string> Build() => new(256, StringComparer.Ordinal)
    {
        ...
        ["Settings_PowerMonitor_LhmPath_Hint"] = "Pick LibreHardwareMonitor.exe. When LHM is offline, 'Start LHM' launches it as administrator (UAC prompt).",
        ["Settings_PowerMonitor_StartLhm"] = "Start LHM",
        ["Settings_PowerMonitor_LhmStarting"] = "Starting LHM... confirm the UAC prompt.",
        ["Settings_PowerMonitor_LhmNotFound"] = "LHM executable not set or not found — pick it via Browse first.",
